...
import youtube_dl
#=============
cl = LineClient(authToken='EDwesDBaKY9s9Te1tpB9.wpxkFj5fqkfJ4IOiPpoukq.5QQNT4bvy6MGCZfK459SBgzF2DNqr7IMzeMRrN/swwU=')
...
ki = LineClient(authToken='EDvCZsAsY1oLGR1auWX4.Ps1ICcuFfMRwOk5e/blqza.FYkwe1Fyz3WBWL3mrTbeZ8S/WX27W+jPrjV1l1rP4Nc=')
...
kk = LineClient(authToken='EDo5y05Y5EUWdmoAqggd.8FoObcuucGEyaI2x85D0pq.0KzgOXO4752Sg7TJeZQhJPGRo2i5eE3nDsky3ouGGVQ=')
...
kc = LineClient(authToken='EDN3GqAkzdHwKfiMiu0e.xb+v9leNGio/e+TRmR0T7G.oosB7BehmBM16JBRWR5+GGE51PxhrS2IJs1cPkFJ4ws=')
...
km = LineClient(authToken='EDjkJLsTaaLF2qlvQz33.F/jlU9YrX9oyHmsSrR6a4W.UiQTW2syD6sXPHakh33wY1bqnjNPSzivXF8rlsOtPSE=')
...
kb = LineClient(authToken='EDKswPXHem3Hky2yFLS3.TEHoPZueG30AfGKoVo+mmW.lxd5BYbmdRfO7xxSwHOeTaZZwmihoZmbyTTaeHgka/0=')
...
kn = LineClient(authToken='EDwesDBaKY9s9Te1tpB9.wpxkFj5fqkfJ4IOiPpoukq.5QQNT4bvy6MGCZfK459SBgzF2DNqr7IMzeMRrN/swwU=')
...
ko = LineClient(authToken='EDc3LakXGi5SfEG23Vu2.aqCG7HhrQYqHrjtbNjJ3OG.1fo4Rz/MRq6Ue4cJMnNASdWgx/l51188JvCD4KJ0czU=')
...
kw = LineClient(authToken='EDndNA37zYbWHDdOu2d0.CNfr+h4xJlPoSgNPZSnEya.o/VHKzrgJe35CVre+D5J3vuZHljXCmhKXzfczRQMjZs=')
...
ke = LineClient(authToken='EDbs09kj2W4hBOUMwQVa.n2xhcoCgqwrUqKsByytYIG.Fb2bA2UNVDJOXLcA9V376ZJhvm0SUN6gJ7FmmNKb4Kc=')
...
ky = LineClient(authToken='EDzkQT0Q5gn7vmigKx8f.x/q1J7lwsLmFDpbupgM2JW.bENVx2VeU5ZOGQgFOsP+b2Ozhd8fGqCRr82VmA+PQCM=')
...
sw = LineClient(authToken='EDgtUkNbQ1zZK8yKwtxc.dVeEPYnmvhY7lnt4eiKO+a.oKy1dPq2eA2mudvzZwYjUgSkRxphmX8UiasTSKszC/w=')
...
staff = ["ud95f6bdc6cf9adab82893ccb0b7bb30a","ud95f6bdc6cf9adab82893ccb0b7bb30a","ud95f6bdc6cf9adab82893ccb0b7bb30a","ud95f6bdc6cf9adab82893ccb0b7bb30a"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
...
def help():
    ...
    helpMessage = "🛠ᎬᏒᎥᏟ ᏴᏫᎢ✔\n" + \
                  ...
                  "╚══[     🛠ᎬᏒᎥᏟ ᏴᏫᎢ✔     ]\n" + \
                  "..ᎬᏒᎥᏟ..\n" + \
                  "\nBOTS CREATED PY ERIC\n"
    return helpMessage

def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "🛠ᎬᏒᎥᏟ ᏴᏫᎢ✔\n" + \
                  "╔══[ ᎻᎬᏞᏴ 2 ]\n"+\
                  "║📝 " + key + "Blc\n" + \
                  "║📝 " + key + "Ban:on\n" + \
                  "║📝 " + key + "Unban:on\n" + \
    ...
    try:
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  sendMention(op.param1, op.param1, "Haii ", ",thx to add me bro")
            ...
            try:
                ...
                if op.param3 in Zmid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        cl.inviteIntoGroup(op.param1,[Zmid])
                        cl.sendMessage(op.param1,"=ᎬᏒᎥᏟ Invited=")
                    else:
                        cl.kickoutFromGroup(op.param1,[op.param2])
                        cl.findAndAddContactsByMid(op.param3)
                        cl.inviteIntoGroup(op.param1,[Zmid])
                     ...
                     return
                        ...
                        if cmd == "selfbot on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"「Created by :  Bardian UDO") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if msg._from in admin:
                            separate = msg.text.split(" ")
                            number = msg.text.replace(separate[0] + " ","pq")
                            groups = cl.getGroupIdsJoined()
                            ret_ = ""
                            try:
                                group = groups[int(number)-1]
